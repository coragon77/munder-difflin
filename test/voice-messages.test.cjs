...
const SECRETS = [
  ...
  [
    'Anthropic key',
    'sk-ant-api03-AbCdEfGhIjKlMnOpQrStUvWx done',
  ...
  [
    'Slack bot token',
    'token xoxb-' + '1234567890-ABCDEFghijklmnop here',
    'xoxb-' + '1234567890-ABCDEFghijklmnop',
  ],
  [
    'Slack app token',
    'xapp-1-A0123456-789012345-abcdef0123 end',
    'xapp-1-A0123456-789012345-abcdef0123',
  ],
  [
    'GitHub PAT',
    'ghp_ABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789 x',
    'ghp_ABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789',
  ],
  [
    'GitHub fine-grained',
    'github_pat_11ABCDEFG0aBcDeFgHiJkLmNoPqRsTuVwXyZ z',
    'github_pat_11ABCDEFG0aBcDeFgHiJkLmNoPqRsTuVwXyZ',
  ],
  ['AWS access key', 'AKIAIOSFODNN7EXAMPLE is the id', 'AKIAIOSFODNN7EXAMPLE'],
  [
    'Google API key',
    'AIzaSyA1234567890_abcdefghijklmnopqrst go',
    'AIzaSyA1234567890_abcdefghijklmnopqrst',
  ],
  [
    'JWT',
    'jwt eyJhbGciOiJIUzI1NiJ9.eyJzdWIiOiIxIn0.SflKxwRJSMeKKF2QT4fwpMeJf36POk6yJ here',
    'eyJhbGciOiJIUzI1NiJ9.eyJzdWIiOiIxIn0.SflKxwRJSMeKKF2QT4fwpMeJf36POk6yJ',
  ],
  [
    'api_key assignment',
    'config api_key=sk_live_thisIsASecretValue123 stored',
    'sk_live_thisIsASecretValue123',
  ],
  ['password assignment', 'login password: hunter2password now', 'hunter2password'],
  [
    'signing_secret assignment',
    'slack signing_secret = 8f9a0b1c2d3e4f5a6b7c done',
    '8f9a0b1c2d3e4f5a6b7c',
  ],
  ...
  [
    'aws_secret_access_key (namespaced label)',
    'creds aws_secret_access_key=wJalrXUtnFEMI/K7MDENG/bPxRfiCYEXAMPLEKEY here',
    'wJalrXUtnFEMI/K7MDENG/bPxRfiCYEXAMPLEKEY',
  ],
  [
    'private_key assignment',
    'config private_key=abc123DEF456ghi789jkl012mno here',
