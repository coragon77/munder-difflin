...
const ACT_COLOR: Record<string, string> = {
  request: 'var(--cth-peach)',
  inform: 'var(--cth-sky)',
  propose: 'var(--cth-lilac)',
  query: 'var(--cth-lemon)',
  agree: 'var(--cth-mint)',
  refuse: 'var(--cth-coral)',
  done: 'var(--cth-mint)',
};
              ...
              >
                {thread.messages.map((m) => {
                  ...
                  return (
                    <div
                      key={m.id}
                      style={{ borderLeft: '2px solid var(--cth-ink-100)', paddingLeft: 8 }}
                    >
                      <div
                      ...
                      >
                        ...
                        <span
                          style={{
                            ...
                            boxShadow: `inset 0 0 0 1px ${ACT_COLOR[m.act] ?? 'var(--cth-ink-300)'}`,
                            color: 'var(--cth-ink-900)',
                          }}
                        >
                          {m.act}
                        ...
                        <span
                          style={{ marginLeft: 'auto', fontSize: 12, color: 'var(--cth-ink-500)' }}
                        >
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: 6, marginTop: 4 }}>
                  <textarea
                    ...
                    onChange={(e) =>
                      setDrafts((d) => ({ ...d, [thread.conversation]: e.target.value }))
                    }
                  ...
                  <div style={{ display: 'flex', justifyContent: 'flex-end' }}>
                    <PixelButton
                      size="sm"
                      onClick={() => sendReply(last)}
                      disabled={!(drafts[thread.conversation] ?? '').trim()}
                    >
                      Send
                    </PixelButton>
                  </div>
