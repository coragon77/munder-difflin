            ...
            {inClosingTime ? (
                ...
                <div style={{ display: 'flex', gap: 12, alignItems: 'flex-start' }}>
                    ...
                    style={{
                      ...
                      background:
                        closing!.phase === 'complete'
                          ? 'var(--cth-mint-light, #cdeccd)'
                          : 'var(--cth-lemon-light, #f6ecc4)',
                  ...
                  <div style={{ flex: 1 }}>
                    ...
                    <div style={{ fontSize: 15, lineHeight: '22px', color: 'var(--cth-ink-700)' }}>
                      {closing!.phase === 'complete' ? (
                        <>
                          Every agent saved its memory and the orchestrator confirmed the shutdown.
                          The harness closes itself in a moment.
                        </>
                      ) : (
                        <>
                          The orchestrator broadcast closing time. Every worker parks its work,
                          saves its memory, and reports back — the app closes only after the
                          orchestrator confirms nothing will be lost.
                        </>
                      )}
                    </div>
                  </div>
                ...
                >
                  ...
                  {closing!.phase === 'timeout' && (
                    <div style={{ marginTop: 6, fontFamily: 'var(--cth-font-body, inherit)' }}>
                      This is taking a while (an agent may be mid-compaction or deep in a tool
                      call). Keep waiting, or force quit and accept the data loss.
                    </div>
                  )}
                </div>
              ...
              <>
                  ...
                  <div style={{ flex: 1 }}>
                    ...
                    <div style={{ fontSize: 15, lineHeight: '22px', color: 'var(--cth-ink-700)' }}>
                      ...
                      {ptyCount === 1
                        ...
                        : `all ${ptyCount} running claude sessions`}{' '}
                ...
                >
                  ...
                  every agent commit its work and save its memory, and the app closes itself once
                  the whole floor has confirmed. No data loss.
                </div>
